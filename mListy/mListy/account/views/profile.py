...
class ProfileDetailsView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['user_lists'] = List.objects.prefetch_related('listentry_set__movie').filter(
        ...
        context['total_average_grade'] = sum(entries_dict.values()) // context['total_movies'] \
            if context['total_movies'] else 0
        context['last_added'] = sorted(entries_dict.items(), key=lambda x: x[0].date_created, reverse=True)[0:5]
        return context
